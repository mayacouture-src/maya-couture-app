...
export function PaymentForm({ reservationId }: { reservationId: string }) {
  const action = recordPayment.bind(null, reservationId);
  ...
  return (
    <form action={formAction} className="space-y-3">
      ...
      <div className="space-y-1">
        ...
        <Input id="description" name="description" placeholder="ex. Acompte 50%" />
      </div>
